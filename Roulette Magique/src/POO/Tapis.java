...
public class Tapis {
	...
	public int CalculerGainCase(int num_tombe) {
		...
		if (tab[num_tombe].getMise() != 0) {
			gain = gain
					+ ((tab[num_tombe].getMise() * tab[num_tombe]
							.getCoefMultiplicateur()) + tab[num_tombe]
							.getMise());
		}
		...
		if (tab[37].getMise() != 0) {
			if (num_tombe % 2 == 1 && num_tombe != 0) {
				gain = gain
						+ ((tab[37].getMise() * tab[37].getCoefMultiplicateur()) + tab[37]
								.getMise());
			} else if (num_tombe == 0) {
		...
		if (tab[38].getMise() != 0) {
			if (num_tombe % 2 == 0 && num_tombe != 0) {
				gain = gain
						+ ((tab[38].getMise() * tab[38].getCoefMultiplicateur()) + tab[38]
								.getMise());
			} else if (num_tombe == 0) {
		...
		if (tab[39].getMise() != 0) {
			if (num_tombe < 19 && num_tombe != 0) {
				gain = gain
						+ ((tab[39].getMise() * tab[39].getCoefMultiplicateur()) + tab[39]
								.getMise());
			} else if (num_tombe == 0) {
	...
	public int CalculerGainTransversale(int num_tombe) {
		...
		case 2:
		case 3:
			if (tab_transversale[1] != null) {
				gain = gain
						+ ((11 * tab_transversale[1]) + tab_transversale[1]);
			}
			break;
		case 4:
		case 5:
		case 6:
			if (tab_transversale[2] != null) {
				gain = gain
						+ ((11 * tab_transversale[2]) + tab_transversale[2]);
			}
			break;
		case 7:
		case 8:
		case 9:
			if (tab_transversale[3] != null) {
				gain = gain
						+ ((11 * tab_transversale[3]) + tab_transversale[3]);
			}
			break;
		case 10:
		case 11:
		case 12:
			if (tab_transversale[4] != null) {
				gain = gain
						+ ((11 * tab_transversale[4]) + tab_transversale[4]);
			}
			break;
		case 13:
		case 14:
		case 15:
			if (tab_transversale[5] != null) {
				gain = gain
						+ ((11 * tab_transversale[5]) + tab_transversale[5]);
			}
			break;
		case 16:
		case 17:
		case 18:
			if (tab_transversale[6] != null) {
				gain = gain
						+ ((11 * tab_transversale[6]) + tab_transversale[6]);
			}
			break;
		case 19:
		case 20:
		case 21:
			if (tab_transversale[7] != null) {
				gain = gain
						+ ((11 * tab_transversale[7]) + tab_transversale[7]);
			}
			break;
		case 22:
		case 23:
		case 24:
			if (tab_transversale[8] != null) {
				gain = gain
						+ ((11 * tab_transversale[8]) + tab_transversale[8]);
			}
			break;
		case 25:
		case 26:
		case 27:
			if (tab_transversale[9] != null) {
				gain = gain
						+ ((11 * tab_transversale[9]) + tab_transversale[9]);
			}
			break;
		case 28:
		case 29:
		case 30:
			if (tab_transversale[10] != null) {
				gain = gain
						+ ((11 * tab_transversale[10]) + tab_transversale[10]);
			}
			break;
		case 31:
		case 32:
		case 33:
			if (tab_transversale[11] != null) {
				gain = gain
						+ ((11 * tab_transversale[11]) + tab_transversale[11]);
			}
			break;
		case 34:
		case 35:
		case 36:
			if (tab_transversale[12] != null) {
				gain = gain
						+ ((11 * tab_transversale[12]) + tab_transversale[12]);
			}
			break;
		}
	...
	public int CalculerGainCarre(int num_tombe) {
		...
		for (int i = 0; i < 37; i++) {
			for (int j = 0; j < 37; j++) {
				for (int k = 0; k < 37; k++) {
					for (int l = 0; l < 37; l++) {
						if ((num_tombe == i || num_tombe == j || num_tombe == k || num_tombe == l)
								&& tab_carre[i][j][k][l] != null) {
							gain = gain
									+ ((8 * tab_carre[i][j][k][l]) + tab_carre[i][j][k][l]);
						}
					}
				}
			}
	...
	public int CalculerGainSizain(int num_tombe) {
		...
		case 5:
		case 6:
			if (tab_sizain[1] != null) {
				gain = gain + ((5 * tab_sizain[1]) + tab_sizain[1]);
			}
			break;
		case 7:
		case 8:
		...
		case 11:
		case 12:
			if (tab_sizain[2] != null) {
				gain = gain + ((5 * tab_sizain[2]) + tab_sizain[2]);
			}
			break;
		case 13:
		case 14:
		...
		case 17:
		case 18:
			if (tab_sizain[3] != null) {
				gain = gain + ((5 * tab_sizain[3]) + tab_sizain[3]);
			}
			break;
		case 19:
		case 20:
		...
		case 23:
		case 24:
			if (tab_sizain[4] != null) {
				gain = gain + ((5 * tab_sizain[4]) + tab_sizain[4]);
			}
			break;
		case 25:
		case 26:
		...
		case 29:
		case 30:
			if (tab_sizain[5] != null) {
				gain = gain + ((5 * tab_sizain[5]) + tab_sizain[5]);
			}
			break;
		case 31:
		case 32:
		...
		case 35:
		case 36:
			if (tab_sizain[6] != null) {
				gain = gain + ((5 * tab_sizain[6]) + tab_sizain[6]);
			}
			break;
		}
	...
	public int CalculerGainDouzaine(int num_tombe) {
		...
		case 11:
		case 12:
			if (tab_douzaine[1] != null) {
				gain = gain + ((2 * tab_douzaine[1]) + tab_douzaine[1]);
			}
			break;
		case 13:
		case 14:
		...
		case 23:
		case 24:
			if (tab_douzaine[2] != null) {
				gain = gain + ((2 * tab_douzaine[2]) + tab_douzaine[2]);
			}
			break;
		case 25:
		case 26:
		...
		case 35:
		case 36:
			if (tab_douzaine[3] != null) {
				gain = gain + ((2 * tab_douzaine[3]) + tab_douzaine[3]);
			}
			break;
		}
	...
	public int CalculerGainColonne(int num_tombe) {
		...
		case 31:
		case 34:
			if (tab_colonne[1] != null) {
				gain = gain + ((2 * tab_colonne[1]) + tab_colonne[1]);
			}
			break;
		case 2:
		case 5:
		...
		case 32:
		case 35:
			if (tab_colonne[2] != null) {
				gain = gain + ((2 * tab_colonne[2]) + tab_colonne[2]);
			}
			break;
		case 3:
		case 6:
		...
		case 33:
		case 36:
			if (tab_colonne[3] != null) {
				gain = gain + ((2 * tab_colonne[3]) + tab_colonne[3]);
			}
			break;
		}
