...
public class Partie extends JPanel implements Observer{
	...
	private JLabel mise;
	private Jeu partie;
	private JRadioButton numero_button = new JRadioButton("NumŽro");
	...
	private JRadioButton carre_button = new JRadioButton("CarrŽ");
...
_____________________________________________________________________________________________*/	
		...
		//Bouton Arreter Roue
		JButton arreter_roue = new JButton("Arrter Roue");
...
_____________________________________________________________________________________________*/	
		...
		JButton accelerer_roue = new JButton("AccŽlŽrer Roue");
			...
			public void actionPerformed(ActionEvent e) {
				if(Integer.parseInt(mise.getText()) <= partie.solde_compte()){
					if(pair_button.isSelected()){
						...
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur Pair");
						liste_mise.add("pair");
						liste_num1.add(-1);
						liste_num2.add(-1);
						liste_num3.add(-1);
					...
					if(impair_button.isSelected()){
						...
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur Impair");
					...
					if(manque_button.isSelected()){
						partie.MiserImpair(num_bille_selector.getSelectedIndex(), Integer.parseInt(mise.getText()));
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur Manque");
					...
					if(passe_button.isSelected()){
						partie.MiserImpair(num_bille_selector.getSelectedIndex(), Integer.parseInt(mise.getText()));
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur Passe");
					...
					if(numero_button.isSelected()){
						...
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur " + numero_selector.getSelectedIndex());
					...
					if(cheval_button.isSelected()){
						if(numero_cheval_selector_1.isEnabled() && numero_cheval_selector_2.isEnabled() ){
							...
							listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur " + numero_cheval_selector_1.getSelectedItem() + "," + numero_cheval_selector_2.getSelectedItem());
					...
					if(transversale_button.isSelected()){
						...
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur " + transversale_selector.getSelectedItem());
					...
					if(carre_button.isSelected()){
						if(numero_carre_selector_1.isEnabled() && numero_carre_selector_2.isEnabled() && numero_carre_selector_3.isEnabled() && numero_carre_selector_4.isEnabled()){
							...
							listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur " + (Integer) numero_carre_selector_1.getSelectedItem() + "," + (Integer) numero_carre_selector_2.getSelectedItem() + "," + (Integer) numero_carre_selector_3.getSelectedItem() + "," + (Integer) numero_carre_selector_4.getSelectedItem());
					...
					if(sizain_button.isSelected()){
						...
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur " + sizain_selector.getSelectedItem());
					...
					if(douzaine_button.isSelected()){
						...
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur " + douzaine_selector.getSelectedItem());
					...
					if(colonne_button.isSelected()){
						...
						listmodel.addElement(num_bille_selector.getSelectedItem() + " "   + mise.getText() + "Û sur " + colonne_selector.getSelectedItem());
